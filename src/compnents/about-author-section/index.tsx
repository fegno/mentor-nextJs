...
const AboutAuthorSection: React.FC = () => {
    ...
    const AUTHORS = [
        { name: "Ramkumar S", photo: director.src, designation: " Director | Mentor Academy for Design Entrepreneurship Innovation and Technology", description: "Ramkumar S is an accomplished professional with extensive experience in the healthcare entrepreneurship industry and academia. He has held various leadership roles throughout his career and was the Chief Operating Officer at the Center for Healthcare Entrepreneurship at the Indian Institute of Technology, Hyderabad.",description2:"In his current role, Ramkumar is responsible for driving the center's mission to foster innovation and entrepreneurship in the healthcare industry. He works closely with faculty members, students, and industry experts to develop cutting-edge solutions to address some of the most pressing challenges in healthcare. Additionally, he oversees the center's operations, ensuring that all programs and initiatives are executed efficiently and effectively.", linked_in_profile:"https://www.linkedin.com/in/ramkumar-sreedharan-nair-73232619a/" },
