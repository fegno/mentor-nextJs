...
export const COURSES = [
  {
    ...
    details: [
      ...
      { title: "Job Oppurtunities " ,data:[
        {title:"Types of companies posting jobs in India",chart:jobchart.src},
        {title:"Required skills in India",chart:jobchart.src},
        {title:"Blockchain platform wise jobs in India",chart:jobchart.src},
      ]},
    ],
  },
  {
